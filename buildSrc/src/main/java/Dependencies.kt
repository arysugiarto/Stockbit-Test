object Version {
    ...
    const val facebookLoginVersion = "[8,9)"
    ...
    const val glideSvgVersion = "2.0.4"
    ...
    const val googlePlayServicesVersion = "19.0.0"

    const val easyPermissionVersion = "3.0.0"

    const val hawkVersion = "2.0.1"
...
object Dependencies {
    ...
    object UI {
        ...
        const val circleIndicator = "me.relex:circleindicator:${Version.circleIndicatorVersion}"

        val uiDependencies = mutableListOf(
            activityKtx, fragmentKtx, appCompat, materialDesign, constraintLayout, intuitSdp, intuitSsp,
            googleMaps, googleMapsPlaces, googleMapsLocation, viewPager2, circleIndicator
        )
    }
    ...
    object Firebase {
        ...
        const val googlePlayServices = "com.google.android.gms:play-services-auth:${Version.googlePlayServicesVersion}"
    }
